...
def run_test_zero_changer():
    ...
    test2 = ([0, 4, 0, 9], [77, 0, 0, 1, 5, 0], [4, 4, 4], [4, 0, 4])
    expected2 = ([1, 4, 2, 9], [77, 3, 4, 1, 5, 5], [4, 4, 4], [4, 6, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    test3 = ([0, 4, 0, 9], [0], [4, 0, 4])
    expected3 = ([1, 4, 2, 9], [3], [4, 4, 4])
    zero_changer(test3)
    print()
    print('Test 3:')
